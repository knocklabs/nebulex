defmodule Knock.Nebulex.Utils do
  @moduledoc """
  General purpose utilities.
  """

  # Nebulex wrappable exceptions
  @nbx_wrappable_exception [Knock.Nebulex.Error, Knock.Nebulex.KeyError]

  # Nebulex exceptions
  @nbx_exception [Knock.Nebulex.CacheNotFoundError, Knock.Nebulex.QueryError | @nbx_wrappable_exception]
  ...
  ## Example
      ...
      iex> import Knock.Nebulex.Utils, only: [is_nebulex_exception: 1]
      iex> is_nebulex_exception(%Knock.Nebulex.Error{reason: :error})
      true
  ...
  ## Example
      ...
      iex> import Knock.Nebulex.Utils, only: [is_nebulex_wrappable_exception: 1]
      iex> is_nebulex_wrappable_exception(%Knock.Nebulex.Error{reason: :error})
      true
      iex> is_nebulex_wrappable_exception(%Knock.Nebulex.KeyError{reason: :error})
      true
      iex> is_nebulex_wrappable_exception(%Knock.Nebulex.CacheNotFoundError{})
      false
      iex> is_nebulex_wrappable_exception(%Knock.Nebulex.QueryError{})
      false
  ...
  ## Examples
      ...
      iex> import Knock.Nebulex.Utils, only: [is_timeout: 1]
      iex> is_timeout(1)
      true
  ...
  ## Example
      ...
      iex> import Knock.Nebulex.Utils
      iex> unwrap_or_raise {:ok, "ok"}
      "ok"
      iex> unwrap_or_raise {:error, %Knock.Nebulex.Error{reason: :error}}
      ** (Knock.Nebulex.Error) command failed with reason: :error
  ...
  ## Example
      ...
      iex> import Knock.Nebulex.Utils
      iex> wrap_error Knock.Nebulex.Error, reason: :error
  ...
  ## Examples
      ...
      iex> Knock.Nebulex.Utils.get_option(
      ...>   [keys: [1, 2, 3]],
      ...>   :keys,
  ...
  ## Examples
      ...
      iex> Knock.Nebulex.Utils.camelize_and_concat([Foo, :bar])
      Foo.Bar

      iex> Knock.Nebulex.Utils.camelize_and_concat([Foo, "bar"])
      Foo.Bar

      iex> Knock.Nebulex.Utils.camelize_and_concat([Foo, "Bar", 1])
      :"Elixir.Foo.Bar.1"
