defmodule Knock.Nebulex.Adapter.KV do
  @moduledoc """
  ...
  See `c:Knock.Nebulex.Cache.fetch/2`.
  """
  @callback fetch(adapter_meta(), key(), opts()) ::
              Knock.Nebulex.Cache.ok_error_tuple(value, Knock.Nebulex.Cache.fetch_error_reason())
  ...
  See `c:Knock.Nebulex.Cache.put/3`, `c:Knock.Nebulex.Cache.put_new/3`,
  `c:Knock.Nebulex.Cache.replace/3`.
  """
  ...
  See `c:Knock.Nebulex.Cache.put_all/2` and `c:Knock.Nebulex.Cache.put_new_all/2`.
  """
  ...
  See `c:Knock.Nebulex.Cache.delete/2`.
  """
  @callback delete(adapter_meta(), key(), opts()) :: :ok | Knock.Nebulex.Cache.error_tuple()
  ...
  See `c:Knock.Nebulex.Cache.take/2`.
  """
  ...
  See `c:Knock.Nebulex.Cache.incr/3`.
  See `c:Knock.Nebulex.Cache.decr/3`.
  """
  @callback update_counter(adapter_meta(), key(), amount, default, ttl(), opts()) ::
              Knock.Nebulex.Cache.ok_error_tuple(integer())
  ...
  See `c:Knock.Nebulex.Cache.has_key?/2`.
  """
  @callback has_key?(adapter_meta(), key(), opts()) :: Knock.Nebulex.Cache.ok_error_tuple(boolean())
  ...
  See `c:Knock.Nebulex.Cache.ttl/2`.
  """
  ...
  See `c:Knock.Nebulex.Cache.expire/3`.
  """
  @callback expire(adapter_meta(), key(), ttl(), opts()) :: Knock.Nebulex.Cache.ok_error_tuple(boolean())
  ...
  See `c:Knock.Nebulex.Cache.touch/2`.
  """
  @callback touch(adapter_meta(), key(), opts()) :: Knock.Nebulex.Cache.ok_error_tuple(boolean())
end
