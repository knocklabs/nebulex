defmodule Knock.Nebulex.Cache.Queryable do
  @moduledoc false

  import Knock.Nebulex.Adapter, only: [defcommandp: 1, defcommandp: 2]
  import Knock.Nebulex.Utils, only: [unwrap_or_raise: 1]

  alias Knock.Nebulex.Cache.{Options, QuerySpec}

  @doc """
  Implementation for `c:Knock.Nebulex.Cache.get_all/2`.
  """
  ...
  @doc """
  Implementation for `c:Knock.Nebulex.Cache.count_all/2`.
  """
  ...
  @doc """
  Implementation for `c:Knock.Nebulex.Cache.delete_all/2`.
  """
  ...
  @doc """
  Implementation for `c:Knock.Nebulex.Cache.stream/2`.
  """
