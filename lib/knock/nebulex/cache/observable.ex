defmodule Knock.Nebulex.Cache.Observable do
  @moduledoc false
  ...
  @doc """
  Implementation for `c:Knock.Nebulex.Cache.register_event_listener/2`.
  """
  ...
  @doc """
  Implementation for `c:Knock.Nebulex.Cache.unregister_event_listener/2`.
  """
