defmodule Knock.Nebulex.Cache.KV do
  @moduledoc false

  import Knock.Nebulex.Adapter
  import Knock.Nebulex.Utils, only: [is_timeout: 1, unwrap_or_raise: 1, wrap_error: 2]

  alias Knock.Nebulex.Cache.Options

  # Inline common instructions
  @compile inline: [do_put: 7, do_put_all: 5, do_expire: 4, do_incr: 6]

  @doc """
  Implementation for `c:Knock.Nebulex.Cache.fetch/2`.
  """
  ...
  @doc """
  Implementation for `c:Knock.Nebulex.Cache.get/3`.
  """
  ...
  defp do_get(adapter_meta, key, default, opts) do
    with {:error, %Knock.Nebulex.KeyError{key: ^key}} <- run_command(adapter_meta, :fetch, [key], opts) do
      {:ok, default}
    end
  end
  ...
  @doc """
  Implementation for `c:Knock.Nebulex.Cache.put/3`.
  """
  ...
  @doc """
  Implementation for `c:Knock.Nebulex.Cache.put_new/3`.
  """
  ...
  @doc """
  Implementation for `c:Knock.Nebulex.Cache.replace/3`.
  """
  ...
  @doc """
  Implementation for `c:Knock.Nebulex.Cache.put_all/2`.
  """
  ...
  @doc """
  Implementation for `c:Knock.Nebulex.Cache.put_new_all/2`.
  """
  ...
  @doc """
  Implementation for `c:Knock.Nebulex.Cache.delete/2`.
  """
  ...
  @doc """
  Implementation for `c:Knock.Nebulex.Cache.take/2`.
  """
  ...
  @doc """
  Implementation for `c:Knock.Nebulex.Cache.has_key?/1`.
  """
  defcommand has_key?(name, key, opts)

  @doc """
  Implementation for `c:Knock.Nebulex.Cache.ttl/1`.
  """
  ...
  @doc """
  Implementation for `c:Knock.Nebulex.Cache.expire/2`.
  """
  ...
  @doc """
  Implementation for `c:Knock.Nebulex.Cache.touch/1`.
  """
  ...
  @doc """
  Implementation for `c:Knock.Nebulex.Cache.incr/3`.
  """
  ...
  @doc """
  Implementation for `c:Knock.Nebulex.Cache.decr/3`.
  """
  ...
  @doc """
  Implementation for `c:Knock.Nebulex.Cache.get_and_update/3`.
  """
  ...
  @doc """
  Implementation for `c:Knock.Nebulex.Cache.update/4`.
  """
  def update(name, key, initial, fun, opts) when is_function(fun, 1) do
    ...
    value =
      case run_command(adapter_meta, :fetch, [key], opts) do
        {:ok, value} -> fun.(value)
        {:error, %Knock.Nebulex.KeyError{key: ^key}} -> initial
  ...
  @doc """
  Implementation for `c:Knock.Nebulex.Cache.fetch_or_store/3`.
  """
  def fetch_or_store(name, key, fun, opts) do
    with {:error, %Knock.Nebulex.KeyError{key: ^key}} <- fetch(name, key, opts) do
  ...
  defp eval_fetch_or_store_fun(name, key, fun, opts) do
    case fun.() do
      ...
      {:error, reason} ->
        wrap_error Knock.Nebulex.Error, reason: reason, command: :fetch_or_store, key: key
  ...
  @doc """
  Implementation for `c:Knock.Nebulex.Cache.get_or_store/3`.
  """
