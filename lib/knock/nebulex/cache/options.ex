defmodule Knock.Nebulex.Cache.Options do
  @moduledoc false

  import Knock.Nebulex.Utils, only: [is_timeout: 1, module_behaviours: 1]
  ...
  compile_opts = [
    ...
    adapter: [
      type: {:custom, __MODULE__, :__validate_behaviour__, [Knock.Nebulex.Adapter, Knock.Nebulex.Cache]},
      type_doc: "`t:module/0`",
      required: true,
      doc: """
  ...
  start_link_opts = [
    ...
    bypass_mode: [
      ...
      adapter with `Knock.Nebulex.Adapters.Nil` when the cache starts. This option
  ...
  observable_opts = [
    ...
    filter: [
      type: {:fun, 1},
      type_doc: "`t:Knock.Nebulex.Event.filter/0`",
      required: false,
      doc: """
    ...
    metadata: [
      ...
      type_doc: "`t:Knock.Nebulex.Event.metadata/0`",
      required: false,
      default: [],
      doc: """
  ...
  ## Example
      ...
      iex> keys = Knock.Nebulex.Cache.Options.__compile_opts__()
      iex> is_list(keys)
      true
  ...
  ## Example
      ...
      iex> keys = Knock.Nebulex.Cache.Options.__start_opts__()
      iex> is_list(keys)
      true
  ...
  ## Example
      ...
      iex> keys = Knock.Nebulex.Cache.Options.__runtime_shared_opts__()
      iex> is_list(keys)
      true
  ...
  ## Examples
      ...
      iex> Knock.Nebulex.Cache.Options.pop_and_validate_timeout!([], :timeout)
      {:infinity, []}

      iex> Knock.Nebulex.Cache.Options.pop_and_validate_timeout!([t: 1000], :t)
      {1000, []}

      iex> Knock.Nebulex.Cache.Options.pop_and_validate_timeout!([t: :infinity], :t)
      {:infinity, []}

      iex> Knock.Nebulex.Cache.Options.pop_and_validate_timeout!([k: 1], :t, 1000)
      {1000, [k: 1]}

      iex> Knock.Nebulex.Cache.Options.pop_and_validate_timeout!([t: -1], :t)
      ** (NimbleOptions.ValidationError) invalid value for :t option: expected non-negative integer or :infinity, got: -1

      iex> Knock.Nebulex.Cache.Options.pop_and_validate_timeout!([t: nil], :t)
      ** (NimbleOptions.ValidationError) invalid value for :t option: expected non-negative integer or :infinity, got: nil

      iex> Knock.Nebulex.Cache.Options.pop_and_validate_timeout!([k: 1], :t, :x)
      ** (NimbleOptions.ValidationError) invalid value for :t option: expected non-negative integer or :infinity, got: :x

      iex> Knock.Nebulex.Cache.Options.pop_and_validate_timeout!([k: 1], :t, nil)
      ** (NimbleOptions.ValidationError) invalid value for :t option: expected non-negative integer or :infinity, got: nil
  ...
  ## Examples
      ...
      iex> Knock.Nebulex.Cache.Options.pop_and_validate_integer!([], :int)
      {0, []}

      iex> Knock.Nebulex.Cache.Options.pop_and_validate_integer!([int: 1], :int)
      {1, []}

      iex> Knock.Nebulex.Cache.Options.pop_and_validate_integer!([k: 1], :int, 1)
      {1, [k: 1]}

      iex> Knock.Nebulex.Cache.Options.pop_and_validate_integer!([int: nil], :int)
      ** (NimbleOptions.ValidationError) invalid value for :int option: expected integer, got: nil

      iex> Knock.Nebulex.Cache.Options.pop_and_validate_integer!([k: 1], :int, :x)
      ** (NimbleOptions.ValidationError) invalid value for :int option: expected integer, got: :x

      iex> Knock.Nebulex.Cache.Options.pop_and_validate_integer!([k: 1], :int, nil)
      ** (NimbleOptions.ValidationError) invalid value for :int option: expected integer, got: nil
  ...
  ## Examples
      ...
      iex> Knock.Nebulex.Cache.Options.pop_and_validate_boolean!([], :bool)
      {false, []}

      iex> Knock.Nebulex.Cache.Options.pop_and_validate_boolean!([bool: true], :bool)
      {true, []}

      iex> Knock.Nebulex.Cache.Options.pop_and_validate_boolean!([k: 1], :bool, true)
      {true, [k: 1]}

      iex> Knock.Nebulex.Cache.Options.pop_and_validate_boolean!([bool: nil], :bool)
      ** (NimbleOptions.ValidationError) invalid value for :bool option: expected boolean, got: nil

      iex> Knock.Nebulex.Cache.Options.pop_and_validate_boolean!([k: 1], :bool, :x)
      ** (NimbleOptions.ValidationError) invalid value for :bool option: expected boolean, got: :x

      iex> Knock.Nebulex.Cache.Options.pop_and_validate_boolean!([k: 1], :bool, nil)
      ** (NimbleOptions.ValidationError) invalid value for :bool option: expected boolean, got: nil
