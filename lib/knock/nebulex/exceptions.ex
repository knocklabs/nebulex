defmodule Knock.Nebulex.Error do
  @moduledoc """
  ...
  This exception has the following public fields:
    ...
    * `:metadata` - the metadata contains the options given to the
      ...
      `raise Knock.Nebulex.Error, reason: :test, foo: :bar`, the metadata
      will be `[foo: :bar]`.
...
defmodule Knock.Nebulex.KeyError do
  @moduledoc """
  ...
  This exception has the following public fields:
    ...
    * `:metadata` - the metadata contains the options given to the
      ...
      `raise Knock.Nebulex.KeyError, key: :test, foo: :bar`, the metadata
      will be `[foo: :bar]`.
...
defmodule Knock.Nebulex.CacheNotFoundError do
  @moduledoc """
...
defmodule Knock.Nebulex.QueryError do
  @moduledoc """
