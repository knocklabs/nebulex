defmodule Knock.Nebulex.Event.CacheEntryEvent do
  @moduledoc """
  A cache entry event.
  """
  ...
  """
  @type t() :: %__MODULE__{
          cache: Knock.Nebulex.Cache.t(),
          name: atom() | nil,
          pid: pid() | nil,
          type: type(),
          target: target(),
          command: atom(),
          metadata: Knock.Nebulex.Event.metadata()
        }
  ...
  ## Example
      ...
      iex> Knock.Nebulex.Event.CacheEntryEvent.__types__()
  ...
  ## Example
      ...
      iex> Knock.Nebulex.Event.CacheEntryEvent.new(
      ...>   cache: MyApp.Cache,
      ...>   pid: self(),
      ...>   target: {:key, "foo"},
      ...>   command: :put,
