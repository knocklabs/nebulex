defmodule Knock.Nebulex.Caching.Options do
  @moduledoc false
  ...
  use_caching_opts = [
    default_key_generator: [
      ...
      type_doc: "`t:Knock.Nebulex.Caching.Decorators.key/0`",
      required: false,
      doc: """
      ...
      The default value is `&Knock.Nebulex.Caching.Decorators.generate_key/1`.
      """
    ],
    cache: [
      type: :atom,
    ...
    on_error: [
      ...
      type_doc: "`t:Knock.Nebulex.Caching.Decorators.on_error/0`",
      required: false,
      default: :nothing,
      doc: """
    ...
    match: [
      ...
      type_doc: "`t:Knock.Nebulex.Caching.Decorators.match/0`",
      required: false,
      doc: """
      ...
      The default value is `&Knock.Nebulex.Caching.Decorators.default_match/1`.
      """
    ],
    opts: [
      type: :keyword_list,
  ...
  shared_opts = [
    cache: [
      ...
      caching usage via `use Knock.Nebulex.Caching` either.
    ...
    match: [
      ...
      via `use Knock.Nebulex.Caching, match: &MyApp.match/1`.
    ...
    on_error: [
      ...
      When configured, this option overrides the global value (if any) defined
      via `use Knock.Nebulex.Caching, on_error: ...`.
      """
    ],
    transaction: [
      type: :boolean,
      ...
      **Adapter support:** Transaction behavior and implementation vary by
      adapter. See `c:Knock.Nebulex.Cache.transaction/2` for details on transaction
      semantics and nested transaction handling.

      When configured, this option overrides the global value (if any) defined
      via `use Knock.Nebulex.Caching, transaction: true`.
      """
    ],
    opts: [
      type: :keyword_list,
