defmodule Knock.Nebulex.Telemetry.CacheEntryHandler do
  @moduledoc """
  ...
  @spec register(
          ...
          Knock.Nebulex.Event.listener(),
          Knock.Nebulex.Event.filter(),
          Knock.Nebulex.Event.metadata(),
          keyword()
        ) :: :ok | Knock.Nebulex.Error.t()
  def register(
  ...
  defp do_handle(
         command,
         [key | _],
         {:error, %Knock.Nebulex.KeyError{reason: :expired}},
         event_attrs,
         config
       )
