defmodule Knock.Nebulex.Adapters.Common.Info do
  @moduledoc """
  A simple/default implementation for `Knock.Nebulex.Adapter.Info` behaviour.
  ...
  defmacro __using__(_opts) do
    quote do
      ...
      alias Knock.Nebulex.Adapters.Common.Info
