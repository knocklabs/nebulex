defmodule Knock.Nebulex.Cache.InfoStatsTest do
  ...
  describe "c:Knock.Nebulex.Cache.stats/1" do
    ...
    test "returns an error" do
      ...
      assert Cache.info() == {:error, %Knock.Nebulex.Error{module: Knock.Nebulex.Error, reason: :error}}
    end
    ...
    test "deletions" do
      ...
      assert_raise Knock.Nebulex.KeyError, fn ->
        Cache.take!(20)
      end
  ...
  describe "disabled stats:" do
    ...
    test "c:Knock.Nebulex.Cache.stats/1 returns empty stats when counter is not set" do
