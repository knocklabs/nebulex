defmodule Knock.Nebulex.CachingTest do
  use ExUnit.Case, async: true

  doctest Knock.Nebulex.Caching.Decorators.Context
  ...
  defmodule ErrorCache do
    ...
    use Knock.Nebulex.Cache,
      otp_app: :knock_nebulex,
      adapter: Knock.Nebulex.FakeAdapter
  end
  ...
  use Knock.Nebulex.Caching, cache: Cache
  ...
  describe "caching definition" do
    ...
    test "error: invalid :default_key_generatoroption value" do
      ...
      assert_raise NimbleOptions.ValidationError, msg, fn ->
        defmodule InvalidCompileOptsTest do
          use Knock.Nebulex.Caching, default_key_generator: :invalid
        end
      end
    end
    ...
    test "error: :default_key_generator error (functions in the format &Mod.fun/arity)" do
      assert_raise ArgumentError, ~r"remote functions in the format &Mod.fun/arity", fn ->
        defmodule InvalidCompileOptsTest do
          use Knock.Nebulex.Caching, default_key_generator: & &1
        end
      end
    end
    ...
    test "error: invalid :cache option value" do
      ...
      assert_raise NimbleOptions.ValidationError, msg, fn ->
        defmodule InvalidCompileOptsTest do
          use Knock.Nebulex.Caching, cache: 123
        end
      end
    end
    ...
    test "error: invalid :on_error option value" do
      ...
      assert_raise NimbleOptions.ValidationError, msg <> inspect(:invalid), fn ->
        defmodule InvalidCompileOptsTest do
          use Knock.Nebulex.Caching, on_error: :invalid
        end
      end
    end
    ...
    test "error: invalid :match option value" do
      ...
      assert_raise NimbleOptions.ValidationError, msg <> inspect(:invalid), fn ->
        defmodule InvalidCompileOptsTest do
          use Knock.Nebulex.Caching, match: :invalid
        end
      end
      ...
      assert_raise NimbleOptions.ValidationError, msg <> inspect(match), fn ->
        defmodule InvalidCompileOptsTest do
          use Knock.Nebulex.Caching, match: match
        end
      end
    end
  end
  ...
  describe "option :on_error in annotation" do
    ...
    test "cacheable raises a cache error" do
      assert_raise Knock.Nebulex.Error, ~r"command failed", fn ->
  ...
  describe "option :transaction in annotation" do
    ...
    test "cacheable returns transaction error" do
      assert cacheable_with_txn_returns_error(1) == {:error, %Knock.Nebulex.Error{reason: :error}}
    end
